        ...
        if connection.is_connected():
            with connection.cursor() as cursor:
                ...
                INSERT INTO sigma_alerts (
                    title, tags, description, system_time, computer_name, user_id, event_id, provider_name, dbscan_cluster, ip_address, task, rule_level, target_user_name, target_domain_name, ruleid, raw
                ...
                cursor.execute(insert_query, (
                    ...
                    alert_data.get('IpAddress'),
                    alert_data.get('Task'),
                    alert_data.get('rule_level'),
                    alert_data.get('TargetUserName'),
                    alert_data.get('TargetDomainName'),
                    alert_data.get('id'),
